...
Consumes behavior.events stream (profile_signals.extracted event type) from the 
...
class ColdStartSignalConsumer:
    ...
    async def start(self):
        ...
        reading messages from the behavior.events stream. Filters for 
        ...
        """
        logger.info(f"Starting ColdStartSignalConsumer for stream: {STREAM_NAME}, event_type: {EVENT_TYPE}")
